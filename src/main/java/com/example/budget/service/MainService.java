...
public class MainService {
    ...
    public GetClientMessage withdrawMoneyOnAccount(ManyDto manyDto) throws ParseException {
        MessageTransferObject messageTransferObject = methods.chekWithdrawMoneyOnAccount(manyDto);
        GetClientMessage getClientMessage = new GetClientMessage();
        if (messageTransferObject.isChekResult()) {
            ...
            int withdrawSum;
            try {
                withdrawSum = Integer.parseInt(manyDto.getManyCount());
    ...
    public GetClientMessage applyAdminFamilyRestrictions(FamilyAdminLimitationsDto familyAdminLimitationsDto) throws ParseException {
        GetClientMessage getClientMessage = new GetClientMessage();
        MessageTransferObject messageTransferObject = methods.chekDate(familyAdminLimitationsDto);
        if (messageTransferObject.isChekResult()) {
            UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            ...
            for (FamilyMember faml : familyMemberList) {
                if (faml.getMemberLogin().equals(familyAdminLimitationsDto.getFamilyMemberLogin()) || familyAdminLimitationsDto.getFamilyMemberLogin().equals("На всех")) {
                    ...
                    if (familyAdminLimitationsOptional.isEmpty()) {
                        ...
                        try {
                            familyAdminLimitations.setMaximumOneTimeWithdrawalPerDay(Integer.parseInt(familyAdminLimitationsDto.getMaximumOneTimeWithdrawalPerDay()));
                        } catch (Exception ignored) {

                        }

                        try {
                            familyAdminLimitations.setMaximumWithdrawalPerDay(Integer.parseInt(familyAdminLimitationsDto.getMaximumWithdrawalPerDay()));
                        } catch (Exception ignored) {
                        ...
                        try {
                            familyAdminLimitations.setDateStartLimitation(formatDate.parse(familyAdminLimitationsDto.getDateStartLimitation()));
                        } catch (Exception ignored) {

                        }

                        try {
                            familyAdminLimitations.setDateEndLimitation(formatDate.parse(familyAdminLimitationsDto.getDateEndLimitation()));
                        } catch (Exception ignored) {
            ...
            if (globalAdminAllFamilyLimitationsList.size() == 0) {
                ...
                for (Family family : familyList) {
                    ...
                    if (globalAdminLimitationsOptional.isPresent()) {
                        ...
                        globalAdminAllFamilyLimitations.setMaximumOneTimeWithdrawalPerDay(Integer.parseInt(globalAdminFamilyLimitationsDto.getMaximumOneTimeWithdrawalPerDay()));
                        globalAdminAllFamilyLimitations.setMaximumWithdrawalPerDay(Integer.parseInt(globalAdminFamilyLimitationsDto.getMaximumWithdrawalPerDay()));
                        SimpleDateFormat formatDate = new SimpleDateFormat("yyyy-MM-dd");
                        globalAdminAllFamilyLimitations.setDateStartLimitation(formatDate.parse(globalAdminFamilyLimitationsDto.getDateStartLimitation()));
                        globalAdminAllFamilyLimitations.setDateEndLimitation(formatDate.parse(globalAdminFamilyLimitationsDto.getDateEndLimitation()));
    ...
    public GetClientMessage personalLimitationsGlobalAdmin(FamilyAdminLimitationsDto familyAdminLimitationsDto) throws ParseException {
